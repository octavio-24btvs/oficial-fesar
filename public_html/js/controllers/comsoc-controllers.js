/* global base_url */
angular.module("app").service('comsocService', [
    '$http',
    '$q',
    function ($http, $q) {
...
angular.module("app").controller('comsocCtrl', [
    '$scope',
    'comsocService',
    function ($scope, comsocService) {
        $scope.showing = 0;
        $scope.modal = false;
        $scope.genero = {};
        $scope.banners = [
        ...
        comsocService.getImagesPdfs().then(function (data) {
            $scope.genero.valor_unam = data.data;
        });
        comsocService.getImagesEquidadFES().then(function (data) {
