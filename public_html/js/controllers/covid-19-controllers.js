...
angular.module("app").controller('Covid19Ctrl', [
    ...
    function ($scope, Covid19Service) {
        ...
        $scope.banners = [
            {
                imagen: 'lineamientos-generales.png',
                descripcion: 'Lineamientos Generales',
                hipervinculo: 'https://www.gaceta.unam.mx/lineamientos-generales-para-las-actividades-universitarias-en-el-marco-de-la-pandemia-de-covid-19/'
            },
        ...
        Covid19Service.getComics().then(function (data) {
            $scope.comics = data.data;
        ...
        Covid19Service.getInformacionDeInteres().then(function (data) {
            $scope.informacion_de_interes = data.data;
            $(document).ready(function () {
                var owl = $('.owl-carousel');
                owl.owlCarousel({
                    rtl: false,
        ...
        Covid19Service.getInformacionOficial().then(function (data) {
            $scope.informacion_oficial = data.data;
            $(document).ready(function () {
                var owl = $('.owl-carousel');
                owl.owlCarousel({
                    rtl: false,
        ...
        $scope.showModal = function (imagen, seccion) {
            if (!imagen.secundaria) {
                ...
                $scope.image_source = 'public_html/img/covid-19/' + seccion + '/secundarias/' + imagen.imagen + '';
            }
